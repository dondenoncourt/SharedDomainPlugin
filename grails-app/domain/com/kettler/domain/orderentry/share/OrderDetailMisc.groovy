...
class OrderDetailMisc implements Serializable {
	String compCode
	int orderNo
	int shipNo
	int lineNo
	...
	boolean flatChargeCode = false

	String toString() {"$compCode:$orderNo:$shipNo:$lineNo:$desc: distrCode:$distrCode amount:$amount, cost:$cost"	}
	...
	static constraints = {
		...
		flatChargeCode(maxSize:1,nullable:false)
	}
	static final boolean ASSIGNED_KEY = true
	static final boolean COMPOSITE_KEY  = true
	static mapping = {
		table (name:'oeord2',schema:CH.config.orderentry.schema)
		version (false)
		...
		columns {
			...
			flatChargeCode (column:'OFLTCG', type:'YesBlankType')
		}
	}
