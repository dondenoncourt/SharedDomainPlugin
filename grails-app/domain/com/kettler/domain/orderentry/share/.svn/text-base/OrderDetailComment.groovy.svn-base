...
class OrderDetailComment implements Serializable {
	String compCode
	int orderNo
	int shipNo = 0
	int lineNo
	...
	static mapping = {
		table (name:'oeord3',schema:CH.config.orderentry.schema)
		version (false)
	...
	String toString() {"orderNo: $orderNo lineNo: $lineNo text: $text printCode(s): $printCode $printCode2 $printCode3 $printCode4 $printCode5 $printCode5 "}
}
